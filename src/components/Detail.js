...
export default function Detail() {
  const [dayOfWeek, month, day, year, time, timezone] = data.date.split(" ");
  ...
  return (
    <div className="w-full h-full card pb-5 lg:pb-0">
      <div className="flex items-center w-full h-1/6 gap-6 pl-5">
        <div className="w-10 h-10 sm:w-12 sm:h-12">
          <Clock width="100%" height="100%" color="white" />
        </div>
        <p className="text-[16px] sm:text-[24px] lg:text-[32px] font-medium">{timezone}</p>
      </div>
