...
export default function Menu() {
  return (
    <div className="flex flex-row lg:flex-col items-center card h-full justify-around">
    <img src={headerIcon} width={100} height={100} alt="headerIcon" className="hidden lg:flex"/>
