...
export default function WeatherToday() {
  return (
    <div className="flex w-full h-full">
      <div className="h-full flex flex-col justify-between items-center w-2/6 border-2 xl:w-1/6 lg:items-start">
        <div className="flex flex-col lg:gap-3 justify-between">
          <div className="flex flex-col lg:gap-2 sm:flex-row lg:flex-col xl:flex-row items-center">
            ...
            <p className="text-[16px] sm:text-[20px] lg:text-[24px]">{data.city}</p>
          </div>
          <p className="text-[18px] sm:text-[24px] lg:text-[32px]">{data.type}</p>
        </div>
        <p className="text-[24px] sm:text-[36px] lg:text-[48px] xl:text-[64px]">{data.degree}°C</p>
      </div>
      <div className="flex flex-col sm:flex-row items-center w-4/6 border-2 xl:w-5/6 justify-around">
